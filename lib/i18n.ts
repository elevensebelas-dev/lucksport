...
const id: Dict = {
  ...
  "hero.2.eyebrow": "Luck Sport",
  "hero.2.title": "Performa di Setiap Langkah",
  "hero.2.subtitle": "Perlengkapan olahraga berkualitas untuk mendukung aktivitasmu.",
  "hero.2.cta": "Belanja Sekarang",
...
const en: Dict = {
  ...
  "hero.2.eyebrow": "Luck Sport",
  "hero.2.title": "Performance in Every Stroke",
  "hero.2.subtitle": "Quality sports gear to support your every move.",
  "hero.2.cta": "Shop Now",
